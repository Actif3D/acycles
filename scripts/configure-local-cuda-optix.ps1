...
if (Test-Path $cachePath) {
  Select-String -Path $cachePath -Pattern "WITH_(USD|CYCLES_USD|CYCLES_HYDRA_RENDER_DELEGATE|CYCLES_DEVICE_CUDA|CYCLES_DEVICE_OPTIX|STRICT_BUILD_OPTIONS)|OPTIX_ROOT_DIR" |
