...
grep -E 'WITH_(USD|CYCLES_USD|CYCLES_HYDRA_RENDER_DELEGATE|CYCLES_DEVICE_CUDA|CYCLES_DEVICE_OPTIX|CYCLES_CUDA_BINARIES|CYCLES_CUDA_BUILD_SERIAL|STRICT_BUILD_OPTIONS)|CYCLES_CUDA_BINARIES_ARCH|OPTIX_ROOT_DIR|CYCLES_RUNTIME_OPTIX_ROOT_DIR' "${build_dir}/CMakeCache.txt" || true
